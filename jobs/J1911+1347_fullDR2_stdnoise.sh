#!/bin/bash
#SBATCH --job-name=DR2_J1911+1347_stdnoise_20240716
#SBATCH --partition=scavenge
#SBATCH --exclude=r806u23n04
#SBATCH --output=/home/bbl29/IPTA_DR2_analysis/logs/J1911+1347_DR2full_stdnoise_20240716.txt
#SBATCH --error=/home/bbl29/IPTA_DR2_analysis/logs/error/J1911+1347_DR2full_stdnoise_20240716.txt
#SBATCH --nodes=1
#SBATCH --ntasks=4
