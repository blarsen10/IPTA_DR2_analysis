#!/bin/bash
#SBATCH --job-name=litec_CRN13_FS_advnoise_20241107
#SBATCH --partition=scavenge
#SBATCH --exclude=r806u23n04
#SBATCH --output=/home/bbl29/IPTA_DR2_analysis/logs/litec_CRN13_FS_advnoise_20241107.txt
#SBATCH --error=/home/bbl29/IPTA_DR2_analysis/logs/error/litec_CRN13_FS_advnoise_20241107.txt
#SBATCH --nodes=1
#SBATCH --ntasks=8
...
outdir=/vast/palmer/scratch/mingarelli/bbl29/IPTA_DR2_analysis/chains/dr2litec/CRN${gwb_Nfreqs}_FS_advnoise
