#!/bin/bash
#SBATCH --job-name=DR2lite_J1744-1134_advnoise_20241029
#SBATCH --partition=scavenge
#SBATCH --exclude=r806u23n04
#SBATCH --output=/home/bbl29/IPTA_DR2_analysis/logs/J1744-1134_DR2lite_advnoise_20241029.txt
#SBATCH --error=/home/bbl29/IPTA_DR2_analysis/logs/error/J1744-1134_DR2lite_advnoise_20241029.txt
#SBATCH --nodes=1
#SBATCH --ntasks=4
...
dataset=lite
Niter=350000
outdir=/vast/palmer/scratch/mingarelli/bbl29/IPTA_DR2_analysis/chains/dr2lite/advnoise/J1744-1134
