#!/bin/bash
#SBATCH --job-name=DR2_J2229+2643_stdnoise_20240716
#SBATCH --partition=scavenge
#SBATCH --exclude=r806u23n04
#SBATCH --output=/home/bbl29/IPTA_DR2_analysis/logs/J2229+2643_DR2full_stdnoise_20240716.txt
#SBATCH --error=/home/bbl29/IPTA_DR2_analysis/logs/error/J2229+2643_DR2full_stdnoise_20240716.txt
#SBATCH --nodes=1
#SBATCH --ntasks=4
