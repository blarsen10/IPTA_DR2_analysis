#!/bin/bash
#SBATCH --job-name=DR2lite_unfiltered_J1455-333_advnoise_20250213
#SBATCH --partition=scavenge
#SBATCH --exclude=r806u23n04
#SBATCH --output=/home/bbl29/IPTA_DR2_analysis/logs/J1455-333_DR2lite_unfiltered_advnoise_20250213.txt
#SBATCH --error=/home/bbl29/IPTA_DR2_analysis/logs/error/J1455-333_DR2lite_unfiltered_advnoise_20250213.txt
#SBATCH --nodes=1
#SBATCH --ntasks=4
...
Niter=350000
outdir=/vast/palmer/scratch/mingarelli/bbl29/IPTA_DR2_analysis/chains/dr2lite_unfiltered/advnoise/J1455-333
