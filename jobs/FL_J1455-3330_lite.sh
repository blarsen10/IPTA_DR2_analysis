#!/bin/bash
#SBATCH --job-name=DR2lite_J1455-3330_factlike_20241105
#SBATCH --partition=scavenge
#SBATCH --exclude=r806u23n04
#SBATCH --output=/home/bbl29/IPTA_DR2_analysis/logs/DR2lite_J1455-3330_factlike_20241105.txt
#SBATCH --error=/home/bbl29/IPTA_DR2_analysis/logs/error/DR2lite_J1455-3330_factlike_20241105.txt
#SBATCH --nodes=1
#SBATCH --ntasks=4
