#!/bin/bash
#SBATCH --job-name=HD13_DR2lite_uf_43_advnoise_20250216
#SBATCH --partition=pi_mingarelli
#SBATCH --exclude=r806u23n04
#SBATCH --output=/home/bbl29/IPTA_DR2_analysis/logs/HD13_DR2lite_uf_43_advnoise_20250216.txt
#SBATCH --error=/home/bbl29/IPTA_DR2_analysis/logs/error/HD13_DR2lite_uf_43_advnoise_20250216.txt
#SBATCH --ntasks=1
...
gwb_Nfreqs=13
coredir=/home/bbl29/project/IPTA_DR2_analysis/dr2lite_unfiltered_43/CRN${gwb_Nfreqs}_advnoise
