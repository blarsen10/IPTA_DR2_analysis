#!/bin/bash
#SBATCH --job-name=reweight_GWB13_g4p3_stdnoise_20240904
#SBATCH --partition=pi_mingarelli
#SBATCH --exclude=r806u23n04
#SBATCH --output=/home/bbl29/IPTA_DR2_analysis/logs/reweight_GWB13_g4p3_stdnoise_20240904.txt
#SBATCH --error=/home/bbl29/IPTA_DR2_analysis/logs/error/reweight_GWB13_g4p3_stdnoise_20240904.txt
#SBATCH --ntasks=1
...
coredir=/home/bbl29/project/IPTA_DR2_analysis/dr2full/CRN13_g4p3_stdnoise
