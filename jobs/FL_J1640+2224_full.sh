#!/bin/bash
#SBATCH --job-name=DR2full_J1640+2224_factlike_20241101
#SBATCH --partition=scavenge
#SBATCH --exclude=r806u23n04
#SBATCH --output=/home/bbl29/IPTA_DR2_analysis/logs/DR2full_J1640+2224_factlike_20241101.txt
#SBATCH --error=/home/bbl29/IPTA_DR2_analysis/logs/error/DR2full_J1640+2224_factlike_20241101.txt
#SBATCH --nodes=1
#SBATCH --ntasks=4
