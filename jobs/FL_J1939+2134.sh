#!/bin/bash
#SBATCH --job-name=DR2_J1939+2134_stdnoise_20240828
#SBATCH --partition=pi_mingarelli
#SBATCH --exclude=r806u23n04
#SBATCH --output=/home/bbl29/IPTA_DR2_analysis/logs/J1939+2134_DR2full_stdnoise_20240828.txt
#SBATCH --error=/home/bbl29/IPTA_DR2_analysis/logs/error/J1939+2134_DR2full_stdnoise_20240828.txt
#SBATCH --nodes=1
#SBATCH --ntasks=4
...
psrname=J1939+2134
Niter=350000
outdir=/vast/palmer/scratch/mingarelli/bbl29/IPTA_DR2_analysis/chains/dr2full/stdnoise/J1939+2134
