#!/bin/bash
#SBATCH --job-name=edr2_CRN13_g4p3_advnoise_20250303
#SBATCH --partition=scavenge
#SBATCH --exclude=r806u23n04
#SBATCH --output=/home/bbl29/IPTA_DR2_analysis/logs/edr2_CRN13_g4p3_advnoise_20250303.txt
#SBATCH --error=/home/bbl29/IPTA_DR2_analysis/logs/error/edr2_CRN13_g4p3_advnoise_20250303.txt
#SBATCH --nodes=1
#SBATCH --ntasks=8
...
outdir=/vast/palmer/scratch/mingarelli/bbl29/IPTA_DR2_analysis/chains/edr2/CRN${gwb_Nfreqs}_g4p3_advnoise
