#!/bin/bash
#SBATCH --job-name=DR2_J1643-1224_stdnoise_20240828
#SBATCH --partition=pi_mingarelli
#SBATCH --exclude=r806u23n04
#SBATCH --output=/home/bbl29/IPTA_DR2_analysis/logs/J1643-1224_DR2full_stdnoise_20240828.txt
#SBATCH --error=/home/bbl29/IPTA_DR2_analysis/logs/error/J1643-1224_DR2full_stdnoise_20240828.txt
#SBATCH --nodes=1
#SBATCH --ntasks=4
