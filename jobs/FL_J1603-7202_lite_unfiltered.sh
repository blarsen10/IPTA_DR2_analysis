#!/bin/bash
#SBATCH --job-name=DR2lite_unfiltered_J1603-7202_factlike_20250216
#SBATCH --partition=scavenge
#SBATCH --exclude=r806u23n04
#SBATCH --output=/home/bbl29/IPTA_DR2_analysis/logs/DR2lite_unfiltered_J1603-7202_factlike_20250216.txt
#SBATCH --error=/home/bbl29/IPTA_DR2_analysis/logs/error/DR2lite_unfiltered_J1603-7202_factlike_20250216.txt
#SBATCH --nodes=1
#SBATCH --ntasks=1
