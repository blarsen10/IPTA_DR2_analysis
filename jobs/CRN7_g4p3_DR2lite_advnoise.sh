#!/bin/bash
#SBATCH --job-name=lite_CRN7_g4p3_advnoise_20241016
#SBATCH --partition=scavenge
#SBATCH --exclude=r806u23n04
#SBATCH --output=/home/bbl29/IPTA_DR2_analysis/logs/lite_CRN7_g4p3_advnoise_20241016.txt
#SBATCH --error=/home/bbl29/IPTA_DR2_analysis/logs/error/lite_CRN7_g4p3_advnoise_20241016.txt
#SBATCH --nodes=1
#SBATCH --ntasks=8
...
outdir=/vast/palmer/scratch/mingarelli/bbl29/IPTA_DR2_analysis/chains/dr2lite/CRN${gwb_Nfreqs}_g4p3_advnoise
