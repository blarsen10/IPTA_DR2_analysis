#!/bin/bash
#SBATCH --job-name=DR2_J1643-1224_advnoise_20240925
#SBATCH --partition=pi_mingarelli
#SBATCH --exclude=r806u23n04
#SBATCH --output=/home/bbl29/IPTA_DR2_analysis/logs/J1643-1224_DR2full_advnoise_20240925.txt
#SBATCH --error=/home/bbl29/IPTA_DR2_analysis/logs/error/J1643-1224_DR2full_advnoise_20240925.txt
#SBATCH --nodes=1
#SBATCH --ntasks=4
...
psrname=J1643-1224
Niter=350000
outdir=/vast/palmer/scratch/mingarelli/bbl29/IPTA_DR2_analysis/chains/dr2full/advnoise/J1643-1224
