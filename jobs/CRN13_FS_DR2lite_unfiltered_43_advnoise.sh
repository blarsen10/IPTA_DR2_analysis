#!/bin/bash
#SBATCH --job-name=lite_uf43_CRN13_FS_advnoise_20250215
#SBATCH --partition=scavenge
#SBATCH --exclude=r806u23n04
#SBATCH --output=/home/bbl29/IPTA_DR2_analysis/logs/lite_uf43_CRN13_FS_advnoise_20250215.txt
#SBATCH --error=/home/bbl29/IPTA_DR2_analysis/logs/error/lite_uf43_CRN13_FS_advnoise_20250215.txt
#SBATCH --nodes=1
#SBATCH --ntasks=8
...
outdir=/vast/palmer/scratch/mingarelli/bbl29/IPTA_DR2_analysis/chains/dr2lite_unfiltered_43/CRN${gwb_Nfreqs}_FS_advnoise
