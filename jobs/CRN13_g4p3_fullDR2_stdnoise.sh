...
outdir=/vast/palmer/scratch/mingarelli/bbl29/IPTA_DR2_analysis/chains/dr2full/CRN13_g4p3_stdnoise
...
srun -n $SLURM_NTASKS python3 ./scripts/run_gwb.py --fixed_gamma --dataset $dataset --Niter $Niter --outdir $outdir --emp_dist_path $emp_dist_path --noisedict_path $noisedict_path --human bjorn.larsen
