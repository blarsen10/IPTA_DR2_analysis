#!/bin/bash
#SBATCH --job-name=DR2_J0613-0200_stdnoise_20240716
#SBATCH --partition=pi_mingarelli
#SBATCH --exclude=r806u23n04
#SBATCH --output=/home/bbl29/IPTA_DR2_analysis/logs/J0613-0200_DR2full_stdnoise_20240716.txt
#SBATCH --error=/home/bbl29/IPTA_DR2_analysis/logs/error/J0613-0200_DR2full_stdnoise_20240716.txt
#SBATCH --nodes=1
#SBATCH --ntasks=4
