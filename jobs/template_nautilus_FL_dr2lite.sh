#!/bin/bash
#SBATCH --job-name=DR2lite_{{PSRNAME}}_factlike_{{DATE}}
#SBATCH --partition=scavenge
#SBATCH --exclude=r806u23n04
#SBATCH --output=/home/bbl29/IPTA_DR2_analysis/logs/DR2lite_{{PSRNAME}}_factlike_{{DATE}}.txt
#SBATCH --error=/home/bbl29/IPTA_DR2_analysis/logs/error/DR2lite_{{PSRNAME}}_factlike_{{DATE}}.txt
#SBATCH --nodes=1
#SBATCH --ntasks=4
