#!/bin/bash
#SBATCH --job-name=HM_CRN13_g4p3_DR2lite_advnoise_20241119
#SBATCH --partition=pi_mingarelli
#SBATCH --exclude=r806u23n04
#SBATCH --output=/home/bbl29/IPTA_DR2_analysis/logs/HM_CRN13_g4p3_DR2lite_advnoise_20241119.txt
#SBATCH --error=/home/bbl29/IPTA_DR2_analysis/logs/error/HM_CRN13_g4p3_DR2lite_advnoise_20241119.txt
#SBATCH --nodes=1
#SBATCH --ntasks=8
...
outdir=/vast/palmer/scratch/mingarelli/bbl29/IPTA_DR2_analysis/chains/dr2lite/HM_CRN${gwb_Nfreqs}_g4p3_advnoise
emp_dist_path=/vast/palmer/home.grace/bbl29/IPTA_DR2_analysis/empdists/dr2lite_CRN${gwb_Nfreqs}_g4p3_advnoise.pkl
