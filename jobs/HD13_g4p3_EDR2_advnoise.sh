#!/bin/bash
#SBATCH --job-name=HD13_g4p3_EDR2_advnoise_20250304
#SBATCH --partition=pi_mingarelli
#SBATCH --exclude=r806u23n04
#SBATCH --output=/home/bbl29/IPTA_DR2_analysis/logs/HD13_g4p3_EDR2_advnoise_20250304.txt
#SBATCH --error=/home/bbl29/IPTA_DR2_analysis/logs/error/HD13_g4p3_EDR2_advnoise_20250304.txt
#SBATCH --ntasks=1
...
gwb_Nfreqs=13
coredir=/home/bbl29/project/IPTA_DR2_analysis/edr2/CRN${gwb_Nfreqs}_g4p3_advnoise
